    ...
    http
      ...
      .then((res) => {
        ...
        if (res.data.user) {
          ...
          cookies.set("cookiesToken", res.data.token, {
            path: '/',
          ...
          setErrorMessage(res.data.error); // Set error message
        }
  ...
  return (
    <>
      <div className="wrapper">
        ...
        <div className="text-center mt-3 name">Log In</div>
